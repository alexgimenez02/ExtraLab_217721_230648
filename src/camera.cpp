...
void Camera::renderInMenu()
{
	...
	changed |= ImGui::DragFloat("FOV", &fov, 1, 15, 180);
	changed |= ImGui::DragFloat("Near", &near_plane, 0.1f, 0.01f, far_plane);
	changed |= ImGui::DragFloat("Far", &far_plane, 1.f, near_plane, 1000);
