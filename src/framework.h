...
inline float lerp(float a, float b, float v ) { return a*(1.f-v) + b*v; }
...
inline Vector2 lerp(const Vector2& a, const Vector2& b, float v) { return a*(1.f - v) + b*v; }
...
inline Vector4 lerp(const Vector4& a, const Vector4& b, float v) { return a*(1.f - v) + b*v; }
...
inline Vector4ub lerp(const Vector4ub& a, const Vector4ub& b, float v) { return a*(1.f - v) + b*v; }
